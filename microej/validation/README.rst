...
The `Platform Test Suites <https://docs.microej.com/en/latest/PlatformDeveloperGuide/platformQualification.html#platform-test-suite>`_ validate the Abstraction Layer that implements the Low Level APIs of Foundation Libraries by automatically running Java tests on the device.
...
- A MicroEJ Platform imported in the workspace, which has been `built <https://docs.microej.com/en/latest/VEEPortingGuide/platformCreation.html#platform-build>`_.
...
The README, CHANGELOG and source code of each Test Suite are available online:
