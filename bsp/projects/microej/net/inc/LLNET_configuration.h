 ...
 */
#define LLNET_IPV6_INTERFACE_NAME (char*)"en1"
...
#define LLNET_NETIF_NAMES    {"loopback_interface", "en1"}
#define PLATFORM_NETIF_NAMES {"lo" , "en" }
/* Number of netifs to store */
#define NUMB_OF_NETIF_TO_STORE 2
#else
#define LLNET_NETIF_NAMES    {"en1"}
#define PLATFORM_NETIF_NAMES {"en"}
/* Number of netifs to store */
