 ...
 */
#if LCD_VIRTUAL_BUF_HEIGHT_DIVIDER && (LCD_VIRTUAL_BUF_HEIGHT_DIVIDER == 2)
static const uint8_t s_st7796s_driver_preset_pars035[] = {
    ...
    0x02, ST7796S_CMD_FRMCTR1, 0x30, 0x10,                      // Frame rate control 1
    0x04, ST7796S_CMD_BPC,     0xF0, 0x50, 0x00, 0x20,          // Blanking porch control
